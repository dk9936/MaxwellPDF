...
import com.example.maxwellpdf.databinding.ActivityPdfViewerBinding
import com.example.maxwellpdf.util.FileUtils
import com.example.maxwellpdf.util.PDFViewerCallback
import java.io.File
...
class PdfViewerActivity : AppCompatActivity(), PDFViewerCallback {
   private lateinit var mainBinding: ActivityPdfViewerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainBinding = ActivityPdfViewerBinding.inflate(layoutInflater)
    ...
    private fun setUpToolbar(toolbarTitle: String) {
        setSupportActionBar(mainBinding.pdfViewToolBar.toolbar)
        supportActionBar?.apply {
            setDisplayHomeAsUpEnabled(true)
            setDisplayShowHomeEnabled(true)
            if(mainBinding.pdfViewToolBar.tvAppBarTitle!=null) {
               mainBinding.pdfViewToolBar.tvAppBarTitle?.text = toolbarTitle
    ...
    private fun initPdfViewer(fileUrl: String?, engine: PdfEngine) {
        ...
        try {
            mainBinding.pdfView.initWithUrl(
                fileUrl!!,
                PdfQuality.NORMAL,
                engine
            )
    ...
    private fun initPdfViewerWithPath(filePath: String?) {
        ...
        try {
            ...
            mainBinding.pdfView.initWithFile(
                file,
                PdfQuality.NORMAL
            )
    ...
    private fun enableDownload() {
        ...
        mainBinding.pdfView.statusListener = object : PdfRendererView.StatusCallBack {
    ...
    private fun Boolean.showProgressBar() {
        mainBinding.progressBar.visibility = if (this) View.VISIBLE else GONE
    }
                ...
                try {
                    if (isPDFFromPath) {
                        ...
                        request.setDestinationInExternalPublicDir(
                            FileUtils.getAppPath(directoryName!!),
                            filePath
                        )
                    ...
                    Log.d("dTAG", "downloadPdf: ${e.message}")
                    Toast.makeText(
                        this,
    ...
    override fun onDestroy() {
        super.onDestroy()
        mainBinding.pdfView.closePdfRender()
    }
